...
export interface DriverSpec {
	...
	/** Claude refuses its non-interactive guarded startup in a workspace its own trust store does not know. */
	trustGuardedWorkspace: boolean;
